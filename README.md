...
| `f_yb`                  | Nominal yield stress of the beam's steel material																					|           			| $[\text{MPa}]$			| double     | -																																														|
| `f_ybw`                 | Measured yield stress of the beam's web plate																						|           			| $[\text{MPa}]$			| double     | Based on coupon test results																																									|
| `f_ybf`                 | Measured yield stress of the beam's flange plate																					|           			| $[\text{MPa}]$			| double     | Based on coupon test results																																									|
| `f_yb_mill`             | Yield stress of the beam as per the mill certificate																				|           			| $[\text{MPa}]$			| double     | Weighted average of the beam's flanges and web mill yield stress																																		|
| `f_yb_avg`              | Average yield stress of the beam																								|           			| $[\text{MPa}]$			| double     | Weighted average of $f_{y,bf}$ and $f_{y,bw}$, based on the areas of the flanges and the web																												|
| `l_b`                   | Beam span from column centerline to column centerline																				|           			| $[\text{mm}]$			| double     | For exterior subassemblies consider half the column centerline to centerline distance																													|
| `l_fc`                  | Beam clear span from column face to column face																					|           			| $[\text{mm}]$			| double     | For exterior subassemblies consider half the column face to column face distance																														|
| `l_o`                   | Beam shear span from column face to beam inflection point																			|           			| $[\text{mm}]$			| double     | For exterior subassemblies it equals $l_{fc}$. For interior ones, it equals $l_{fc}/2$																													|
...
| `d_c`                   | Depth of steel column																											|           			| $[\text{mm}]$			| double     | -																																														|
| `t_cw`                  | Thickness of steel column web																									|           			| $[\text{mm}]$			| double     | -																																														|
| `b_cf`                  | Width of steel column flange																									|           			| $[\text{mm}]$			| double     | -																																														|
| `c_c`                   | Distance between steel column fillet radius toes																					|           			| $[\text{mm}]$			| double     | -																																														|
| `t_cf`                  | Thickness of steel column flange																								|           			| $[\text{mm}]$			| double     | -																																														|
| `r_c`                   | Fillet radius of steel column																									|           			| $[\text{mm}]$			| double     | -																																														|
| `a_c`                   | Cross-sectional area of steel column																								|           			| $[\text{mm}^2]$			| double     | -																																														|
| `i_xc`                  | Second moment of area of steel column about major axis																				|           			| $[\text{mm}^4]$			| double     | -																																														|
| `d_cm`                  | Depth of steel column (measured)																								|           			| $[\text{mm}]$			| double     | -																																														|
| `t_wcm`                 | Thickness of steel column web (measured)																							|           			| $[\text{mm}]$			| double     | -																																														|
| `c_cm`                  | Distance between steel column fillet radius toes (measured)																			|           			| $[\text{mm}]$			| double     | -																																														|
| `b_fcm`                 | Width of steel column flange (measured)																							|           			| $[\text{mm}]$			| double     | -																																														|
| `t_fcm`                 | Thickness of steel column flange (measured)																						|           			| $[\text{mm}]$			| double     | -																																														|
| `steel_c`               | Steel grade of the column																										|           			| $[-]$					| string     | -																																														|
| `f_yc`                  | Nominal yield stress of the column's steel material																					|           			| $[\text{MPa}]$			| double     | -																																														|
| `f_ydp`                 | Measured yield stress of the doubler plate(s)																						|           			| $[\text{MPa}]$			| double     | Based on coupon test results																																									|
| `f_ycw`                 | Measured yield stress of the column's web plate																					|           			| $[\text{MPa}]$			| double     | Based on coupon test results																																									|
| `f_ycf`                 | Measured yield stress of the column's flange plate																					|           			| $[\text{MPa}]$			| double     | Based on coupon test results																																									|
| `f_yc_mill`             | Yield stress of the column as per the mill certificate																				|           			| $[\text{MPa}]$			| double     | Weighted average of the column's flanges and web mill yield stress																																	|
| `fyc_avg`               | Average yield stress of the column																								|           			| $[\text{MPa}]$			| double     | Weighted average of $f_{y,cf}$ and $f_{y,cw}$, based on the areas of the flanges and the web																												|
| `h_c`                   | Column height measured from centerline to centerline of the beams																		|           			| $[\text{mm}]$			| double     | -																																														|
...
| `cvn_0f`                | Electrode Charpy V Notch (CVN) value at 0 F																						|           			| $[\text{Nm}]$			| double     | At the beam flange to column face welded connection																																				|
| `cvn_minus20f`          | Electrode Charpy V Notch (CVN) value at -20 F																						|           			| $[\text{Nm}]$			| double     | At the beam flange to column face welded connection																																				|
| `cvn_70f`               | Electrode Charpy V Notch (CVN) value at 70 F																						|           			| $[\text{Nm}]$			| double     | At the beam flange to column face welded connection																																				|
| `access_hole_geometry`  | Type of access hole geometry at the beam																							|           			| $[-]$					| string     | Examples: [Pre-Northridge, AISC-360-16, AIJ]																																						|
| `w`                     | Total width of slab																											|           			| $[\text{mm}]$			| double     | -																																														|
| `w_l`                   | Width of the slab from the center of beam flange to the left edge																		|           			| $[\text{mm}]$			| double     | -																																														|
| `w_r`                   | Width of the slab from the center of beam flange to the right edge																		|           			| $[\text{mm}]$			| double     | -																																														|
| `h_t`                   | Total depth of slab																											|           			| $[\text{mm}]$			| double     | -																																														|
| `a_s`                   | Area of slab reinforcement per meter of beam length																					|           			| $[\text{mm}^2/m]$			| double     | Reinforcement includes rebar and/or wire mesh																																					|
| `f_sk`                  | Nominal yield stress of slab reinforcement 																						|           			| $[\text{MPa}]$			| double     | -																																														|
| `f_sm`                  | Measured yield stress of slab reinforcement																						|           			| $[\text{MPa}]$			| double     | -																																														|
| `h_co`                  | Depth of concrete above steel deck																								|           			| $[\text{mm}]$			| double     | -																																														|
...
| `f_ck`                  | Specified compressive stress of concrete slab																						|           			| $[\text{MPa}]$			| double     | -																																														|
| `f_cm`                  | Measured cylinder compressive stress of concrete slab																				|           			| $[\text{MPa}]$			| double     | -																																														|
...
| `f_c_compr_calc`        | Compressive stress of the concrete slab for compressive force calculation																|           			| $[\text{MPa}]$			| double     | Equals: $f_{cm}$ if provided. Else it equals $f_{ck}$																																				|
| `d`                     | Shear stud diameter																											|           			| $[\text{mm}]$			| double     | -																																														|
| `h_sc`                  | Shear stud height																											|           			| $[\text{mm}]$			| double     | -																																														|
...
| `f_u_sc`                | Ultimate tensile stress of the shear studs																						|           			| $[\text{MPa}]$			| double     | Assumed to be 65 ksi unless the value is reported																																					|
| `h_p`                   | Height of steel deck																											|           			| $[\text{mm}]$			| double     | -																																														|
| `b_o`                   | Average width of rib 																											|           			| $[\text{mm}]$			| double     | Measured at rib centreline																																									|
...
| `d_pz`                  | Depth of column at panel zone location																							|           			| $[\text{mm}]$			| double     | Equals $d_c$																																												|
| `tw_pz`                 | Thickness of column web at panel zone location																						|           			| $[\text{mm}]$			| double     | Equals $t_{cw}$																																											|
| `bf_pz`                 | Width of column flange at panel zone location																						|           			| $[\text{mm}]$			| double     | Equals $b_{cf}$																																											|
| `tf_pz`                 | Thickness of column flange at panel zone location																					|           			| $[\text{mm}]$			| double     | Equals $t_{cf}$																																											|
| `dz`                    | Clear depth of the panel zone																									|           			| $[\text{mm}]$			| double     | Equals: $d_b-2*t_{bf}$																																										|
| `zw`                    | Clear width of the panel zone																									|           			| $[\text{mm}]$			| double     | Equals: $d_{pz}-2*tf_{pz}$																																									|
| `dz_plug`               | Vertical distance between plug welds																								|           			| $[\text{mm}]$			| double     | -																																														|
| `wz_plug`               | Horizontal distance between plug welds																							|           			| $[\text{mm}]$			| double     | -																																														|
| `wd`                    | Width of the doubler plate																										|           			| $[\text{mm}]$			| double     | -																																														|
| `n_dp`                  | Number of doubler plates																										|           			| $[-]$					| int        | -																																														|
| `t_dp`                  | Thickness of one doubler plate																									|           			| $[\text{mm}]$			| double     | -																																														|
| `t_dp_tot`              | Total thickess of doubler plate(s)																								|           			| $[\text{mm}]$			| double     | Equals: $t_{dp}*n_{dp}$																																										|
| `t_p`                   | Thickness of panel zone including doubler plates																					|           			| $[\text{mm}]$			| double     | Equals: $t_{dp,tot}+tw_{pz}$																																									|
| `t_cp`                  | Thickness of the continuity plates																								|           			| $[\text{mm}]$			| double     | -																																														|
| `d_cp`                  | Depth of the continuity plates																									|           			| $[\text{mm}]$			| double     | -																																														|
| `db_plus`               | Effective depth of panel zone on sagging beam side																					|           			| $[\text{mm}]$			| double     | -																																														|
| `db_minus`              | Effective depth of panel zone on hogging beam side																					|           			| $[\text{mm}]$			| double     | -																																														|
| `a_vc`                  | Panel zone shear area according to Eurocode																						|           			| $[\text{mm}^2]$			| double     | According to CEN (2004)																																										|
| `fy_pz_m`               | Measured yield stress of the panel zone																							|           			| $[\text{MPa}]$			| double     | Equals: $fyc_{avg}$																																											|
| `p_cm`                  | Column axial compressive load based on measured yield stress																			|           			| $[\text{kN}]$			| double     | -																																														|
| `n_pm`                  | Column axial load ratio based on measured yield stress (normalized to the column's axial load capacity)										|           			| $[-]$					| double     | -																																														|
| `v_pz_el_m_europe`      | Elastic shear resistance of panel zone according to CEN (2004) based on measured yield stress												|           			| $[\text{kN}]$			| double     | -																																														|
| `r_n_el_m_aisc`         | Elastic shear resistance of panel zone according to AISC (2016) based on measured yield stress												|           			| $[\text{kN}]$			| double     | -																																														|
| `r_n_pl_m_aisc`         | Shear resistance of panel zone considering inelastic deformation based on measured yield stress												|           			| $[\text{kN}]$			| double     | -																																														|
| `v_pz_m_aij`            | Shear resistance of panel zone according to AIJ based on measured yield stress															|           			| $[\text{kN}]$			| double     | -																																														|
| `fy_pz_n`               | Nominal yield stress of panel zone																								|           			| $[\text{MPa}]$			| double     | Equals: $fyc_{avg}$																																											|
| `p_cn`                  | Column axial load (compression) based on nominal yield stress																			|           			| $[\text{kN}]$			| double     | -																																														|
| `n_pn`                  | Column axial load ratio based on nominal yield stress (normalized to the column's axial load capacity)										|           			| $[-]$					| double     | -																																														|
| `v_pz_el_n_europe`      | Elastic shear resistance of panel zone according to Eurocode																			|           			| $[\text{kN}]$			| double     | -																																														|
| `r_n_el_n_aisc`         | Elastic shear resistance of panel zone according to AISC (2016) based on nominal yield stress												|           			| $[\text{kN}]$			| double     | -																																														|
| `r_n_pl_n_aisc`         | Shear resistance of panel zone considering inelastic deformation based on nominal yield stress												|           			| $[\text{kN}]$			| double     | -																																														|
| `v_pz_n_aij`            | Shear resistance of panel zone according to AIJ																					|           			| $[\text{kN}]$			| double     | -																																														|
| `m_cf_minus_n`          | Beam hogging moment at column face at development of beam plastic flexural resistance based on nominal yield stress								|           			| $[\text{kNm}]$			| double     | -																																														|
| `m_cf_plus_n`           | Beam sagging moment at column face at development of beam plastic flexural resistance based on nominal yield stress								|           			| $[\text{kNm}]$			| double     | -																																														|
| `m_cf_minus_m`          | Beam hogging moment at column face at development of beam plastic flexural resistance based on measured yield stress								|           			| $[\text{kNm}]$			| double     | -																																														|
| `m_cf_plus_m`           | Beam sagging moment at column face at development of beam plastic flexural resistance based on measured yield stress								|           			| $[\text{kNm}]$			| double     | -																																														|
| `v_bf_plus_n`           | Panel zone shear force demand from the beam at development of beam plastic flexural resistance under sagging bending								|           			| $[\text{kN}]$			| double     | -																																														|
| `v_bf_minus_n`          | Panel zone shear force demand from the beam at development of beam plastic flexural resistance under hogging bending								|           			| $[\text{kN}]$			| double     | -																																														|
| `v_col_n`               | Column shear force at development of beam plastic flexural resistance																	|           			| $[\text{kN}]$			| double     | -																																														|
| `r_u_n`                 | Panel zone demand at development of beam plastic flexural resistance based on nominal yield stress											|           			| $[\text{kN}]$			| double     | -																																														|
| `r_u_m`                 | Panel zone demand at development of beam plastic flexural resistance based on measured yield stress											|           			| $[\text{kN}]$			| double     | -																																														|
...
| `g_max`                 | Maximum attained panel zone shear distortion in the experiment																		|           			| $[\text{rad}]$			| double     | Maximum absolute panel zone shear distortion																																						|
| `g_y`                   | Panel zone shear distortion at yield																								|           			| $[\text{rad}]$			| double     | -																																														|
